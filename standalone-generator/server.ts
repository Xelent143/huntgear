...
app.post("/api/prefill-seo", async (req, res) => {
    try {
        ...
        const promptText = `
You are an expert SEO Product Copywriter for Sialkot Sample Masters (a B2B custom apparel manufacturer).
    ...
    try {
        ...
        const insertQuery = sql`
            INSERT INTO products (
                ...
                ${data.slug}, ${data.title}, ${data.category}, '<p>High quality custom manufactured product by Sialkot Sample Masters.</p>', ${data.shortDescription},
